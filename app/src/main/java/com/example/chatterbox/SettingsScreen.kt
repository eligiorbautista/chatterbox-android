...
fun SettingsScreen(navController: NavHostController, authViewModel: AuthViewModel) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Settings", fontWeight = FontWeight.SemiBold, color = textColor) },
                navigationIcon = {
            ...
            item {
                ElevatedCard(
                    ...
                    modifier = Modifier
                        ...
                        .clickable { navController.navigate("notificationsSettings") },
            ...
            item {
                ElevatedCard(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 6.dp)
                        .clickable { navController.navigate("securitySettings") },
                    colors = CardDefaults.cardColors(
                        containerColor = backgroundColor,
                        contentColor = textColor
                    )
            ...
            item {
                ElevatedCard(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 6.dp)
                        .clickable { navController.navigate("darkModeSettings") },
                    colors = CardDefaults.cardColors(
                        containerColor = backgroundColor,
                        contentColor = textColor
                    )
